...
export function Contact() {
  return (
    <section id="contact" className="section-padding relative bg-virinchi-dark overflow-hidden text-white">
      {/* Dynamic Background Effects */}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-brand-orange/10 blur-[180px] mix-blend-screen animate-float" />
        <div className="absolute bottom-[-100px] left-[-100px] w-[500px] h-[500px] bg-brand-teal/10 blur-[180px] mix-blend-screen animate-float-delayed" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 md:gap-20">
          <div className="w-full lg:w-[45%]">
            ...
            <h2 className="text-[32px] md:text-[64px] font-[800] leading-tight tracking-tight mb-8">
              Ready to <span className="text-gradient-brand">Elevate</span> Your Brand?
            </h2>
            <p className="text-white/60 text-[18px] mb-12 max-w-md leading-relaxed font-medium">
